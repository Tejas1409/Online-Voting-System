package My_Online_Voting_System;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (rs.next()) {
				...
				ResultSet rsl = preparedStatement2.executeQuery("select vid, pnumber from voters where voter_card_number = '"+voternum+"'");
				if (rsl.next()) {
					String contact = rsl.getString("pnumber");
